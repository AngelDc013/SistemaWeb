            ...
            <div class="col-sm-4 bg-c-lite-green user-profile">
              <div class="card-block text-center text-white">
                <div class="m-b-25">
                  ...
                  <img src="assest/dist/img/Usuario/user_default.png" alt="" class="img" width="200">
                  <?php
}else{
                  ?>

                  <img src="assest/dist/img/Usuario/<?php echo $usuario["foto_usuario"];?>" alt="" class="img" width="300">
                  <?php
}
                  ?>
